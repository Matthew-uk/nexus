  ...
  return (
    <div className='md:px-36 hidden md:flex justify-between items-center font-poppins gap-8 py-4'>
      ...
      <div className='flex items-center justify-center font-poppins'>
        <DropdownMenu>
          <DropdownMenuTrigger className='outline-none ring-offset-0 font-light'>
            <CgProfile size={23} />
          </DropdownMenuTrigger>
          <DropdownMenuContent className='font-poppins'>
            ...
            <DropdownMenuItem>
              <Button
                ...
                className='w-full flex gap-4 bg-red-600 text-sm duration-300 ease-linear'>
                <IoPowerSharp size={18} className='font-bold' /> Logout
              </Button>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
